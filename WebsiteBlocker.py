...
hosts_temp = "hosts"
redirect = "127.0.0.1"
web_sites_list = ["www.facebook.com", "facebook.com"] #users can modify list of the websites they want to block
while True:
        ...
        with open(hosts_path, "r+") as file:
            ...
            for website in web_sites_list:
                if website in content:
                    ...
                    file.wrire(redirect+""+website+"\n")
    else:
        print("Fun time")
        with open(hosts_path, "r+") as file:
            content = file.readlines()
            file.seek(0) # reset pointer to the top of the text file
            for line in content:
